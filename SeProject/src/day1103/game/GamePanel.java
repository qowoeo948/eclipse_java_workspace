...
public class GamePanel extends JPanel{
	...
	public void paint(Graphics g) {
		...
		g2.fillRect(0, 0, WIDTH, HEIGHT); //패널의 크기만큼 사각형이 채워진다
																//(화면을 깨끗하게 닦는 효과)
	...
	//게임윈도우로부터 어떤 방향키가 눌렸는지 전달받자!
	public void moveKey(int key) {
		switch(key) {
		case KeyEvent.VK_LEFT: hero.velX=-2; 
			break;
		case KeyEvent.VK_RIGHT: hero.velX=2; 
		break;
		case KeyEvent.VK_UP: hero.velY=-2; 
		break;
		case KeyEvent.VK_DOWN: hero.velY=2; 
		break;
	...
	public void stopKey(int key) {
		switch(key) {
		case KeyEvent.VK_LEFT: hero.velX=0; 
			break;
		case KeyEvent.VK_RIGHT: hero.velX=0; 
		break;
		case KeyEvent.VK_UP: hero.velY=0; 
		break;
		case KeyEvent.VK_DOWN: hero.velY=0; 
		break;
		}
