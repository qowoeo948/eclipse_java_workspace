...
public class URLLoadApp {
	...
	URLConnection con; //추상클래스이므로, URL 객체로 부터 인스턴스를 얻는다!!
	...
	public URLLoadApp() {
		try {
			url = new URL("https://img.lovepik.com/photo/40008/4913.jpg_wh860.jpg");
			...
			//연결 객체로 부터 스트림을 얻어와서 데이터를 읽어보자!!
			InputStream is = http.getInputStream();
			
			//파일로 저장해보자 (그냥 일반 디렉토리 res에 저장하기)
			File file = new File("C:/Users/user/eclipse-workspace/SeProject/res/copy.jpg");
