...
public class Home extends Page{
	JPanel p_content; //상품 리스트를 담게 될 패널, 추후 상세보기로 전환시 이 패널 자체를 들어내버림
	ArrayList<ProductItem> itemList; //생성된 상품 아이템들을 담게될 리스트~(왜? productItem클래스내에서 이벤트를 구현하면 너무 많은 
																					//정보를 넘겨야하므로, 또한 페이지도 아니면서 너무 많은 정보를 가져와야함)
	...
	public void getProductList() {
		...
		try {
			...
			itemList = new ArrayList<ProductItem>(); //상품 아이템 생성할때마다 리스트에 담기 위함
